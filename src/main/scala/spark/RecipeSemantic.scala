...
object RecipeSemantic extends App {

  val conf = new SparkConf().set("spark.mongodb.output.uri", "mongodb://10.66.188.17:27017/semantic.semantic_recipe_semantic_06-11")
